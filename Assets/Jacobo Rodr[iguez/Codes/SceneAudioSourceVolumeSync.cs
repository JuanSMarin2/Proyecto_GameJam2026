...
public class SceneAudioSourceVolumeSync
{
    ...
    private void BuildVolumeLookups()
    {
        ...
        for (int i = 0; i < soundSO.sounds.Length; i++)
        {
        ...
        if (debugLogs)
            Debug.Log($"[SceneAudioSync] Lookup construido. clips={clipVolumeLookup.Count}, mixers={mixerVolumeLookup.Count}, entriesSO={soundSO.sounds.Length}");
    }
